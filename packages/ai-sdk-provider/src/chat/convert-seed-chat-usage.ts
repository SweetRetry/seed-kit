...
/**
 * Seed API usage response structure
 * @see https://www.seed.com/docs/82379/1494384
 */
...
/**
 * Converts Seed usage data to the AI SDK's LanguageModelV3Usage format.
 *
 * Field mappings:
 ...
 */
export function convertSeedUsage(
  usage: SeedUsage | undefined | null,
  ...
  return {
    inputTokens: {
      ...
      cacheWrite: undefined, // Seed API doesn't report cache write tokens
    },
    outputTokens: {
