...
import {
  convertSeedUsage,
  SeedUsage,
} from './convert-seed-chat-usage';

describe('convertSeedUsage', () => {
  describe('null/undefined handling', () => {
    it('should return undefined values for null usage', () => {
      const result = convertSeedUsage(null);
    ...
    it('should return undefined values for undefined usage', () => {
      const result = convertSeedUsage(undefined);
  ...
  describe('basic token counting', () => {
    it('should convert basic usage without details', () => {
      ...
      const result = convertSeedUsage(usage);
