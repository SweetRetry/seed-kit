...
export type SeedResponsesModelId =
...
export const seedResponsesOptions = lazySchema(() =>
  zodSchema(seedResponsesOptionsSchema),
);

export type SeedResponsesOptions = z.infer<
  typeof seedResponsesOptionsSchema
>;
